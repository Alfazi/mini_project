...
class _BookApiService implements BookApiService {
  ...
  @override
  Future<GenreStatsResponse> getGenreStats() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenreStatsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/stats/genre',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GenreStatsResponse _value;
    try {
      _value = GenreStatsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
